...
export default function PaymentSuccessPage() {
  ...
  const generateReceipt = () => {
    try {
      ...
      console.log('SUCCESS PAGE - searchParams:', searchParams.toString());
      console.log('SUCCESS PAGE - amount from URL:', searchParams.get('amount'));
      console.log('SUCCESS PAGE - item from URL:', searchParams.get('item'));
      
      // Try to get amount from URL, fallback to paymentInfo
      let amount = searchParams.get('amount');
      let itemName = searchParams.get('item');
      
      // If not in URL, try to get from paymentInfo
      if (!amount && paymentInfo) {
        amount = paymentInfo.amount;
        itemName = paymentInfo.itemName;
        console.log('SUCCESS PAGE - using paymentInfo:', paymentInfo);
      }
      ...
      console.log('SUCCESS PAGE - final amount:', amount);
      console.log('SUCCESS PAGE - final itemName:', itemName);
